...
foreach ($orders as $order)
{
	foreach ($order['ITEMS'] as $item)
	{
		...
		if ($reserved[$item['ID']])
		{
			$orders[$order['ID']]['ITEMS'][$item['ID']]['RESERVE'][] = $reserved[$item['ID']];
        }
	}
}
...
<div class="elOrder">
	...
	?>
       ...
       <? foreach($order['ITEMS'] as $item){ ?>
        ...
        <div class="it-item">
            ...
            <div class="it-name">
                <a href="" class="it-name-title"><?=$item['EVENT']['NAME']?></a><br>
            ...
            <div class="it-price"><span><?=$item['EVENT']['PRICE']?> руб.</span></div>
            <div class="it-status">
            ...
            <div class="it-time">
                <? if($order['STATUS_ID'] == 'RS'){?>
                    ...
                    Осталось: <span class="timer" data-expired="<?=$item['RESERVE'][0]['UF_EXPIRED'] - time()?>" id="<?=$item['ID']?>"></span>
                <?}?>
            </div>
    ...
    <!--<div class="it-item">
        ...
        <div class="it-time">Осталось: <b>15 мин</b> <span>30 сек</span></div>
        <div class="it-actions">
            <a href="" target="_blank">Распечатать</a>
        </div>
        <div class="it-delete">
				<span class="delete">
					<svg class="engSvg" xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26">
    ...
    <div class="it-item">
        ...
        <div class="it-price"><span>103 руб.</span></div>
        <div class="it-status">
            <span class="set-red">Просрочен</span>
        </div>
        <div class="it-time">Осталось: <b>15 мин</b> <span>30 сек</span></div>
        <div class="it-actions">
            <a href="" target="_blank">Распечатать</a>
