...
/>*/?>
<form id="elSearch">
    <input id="elSearch-pole" class="cssBorderRadius-left cssLeft"  type="text" name="<?echo $arParams["NAME"]?>" placeholder="Поиск концертов, мероприятий, исполнителей ..." autocomplete="off">
